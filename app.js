...
function lagMixKampoppsett(spillere, playedWith, playedAgainst, gamesPlayed, sitOutCount, lastSitOutRunde, antallBaner, runde, mp) {
  ...
  const { aktive, hviler } = velgAktiveOgHvilere(
    spillere, gamesPlayed, sitOutCount, lastSitOutRunde, antallBaner * 4, runde
  );

  // Steg 2 — Bygg par: greedy, minimiser partner-gjentakelse.
  // Shuffle gir grunnleggende variasjon; noise (<2) < straff (*10).
  ...
  // Steg 3 — Sett par mot hverandre: minimiser motstander-gjentakelse.
